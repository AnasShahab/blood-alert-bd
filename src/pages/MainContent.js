...
import MainSlide from '/home/mr_white/blood-alert-bd/blood-alert-bd/src/components/MainSlide'
        ...
        <div>
            <Container style={{width:'97%'}}>
                ...
                <Grid stackable>
                    ...
                    <Grid.Column className='test1' width={5}></Grid.Column>
                ...
                <Grid stackable divided='vertically'>
                    ...
                    <Grid.Row columns={3}>
                        ...
                        <Grid.Column width={4} className='test'></Grid.Column>
                        ...
                        <Grid.Column width={6} className='test1' textAlign='center'>
                            ...
                            <Container text textAlign='center'>
                                ...
                                <h4>A+ causes this and that. B+ causes...
                                    <a href="">Read more</a>
                                </h4>
                            </Container>
